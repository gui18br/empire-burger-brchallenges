...
function HeaderBottomMenu() {
  ...
  return (
    <div className="absolute md:-bottom-14 -bottom-52 left-1/2 transform -translate-x-1/2 ">
      <div className="bg-white rounded-lg xl:w-970 md:w-[800px] w-[355px] h-[322px] md:h-28 shadow-lg flex align-middle items-center justify-center">
        <ul className="flex flex-col md:flex-row md:ml-6 xl:gap-10 gap-3 md:mr-8">
          {items.map((item, index) => (
            <>
              ...
              <li key={index} className="flex gap-5">
                <div className="bg-400  justify-center rounded-full xl:p-6 md:p-5 p-6 flex items-center">
